    ...
    <div class="layout-login-centered-boxed__form mt-5">
        ...
        <div class="card card-body">
            ...
            <div class="page-separator">
                <div class="page-separator__text">Student Login</div>
            </div>

            <form action="" novalidate method="POST">
                <div class="form-group">
                    <label class="text-label" for="email_2">Student Username:</label>
                    <div class="input-group input-group-merge">
                        <input id="email_2" type="text" name="username" required="" class="form-control form-control-prepended" placeholder="johndoe">
