    ...
    <div class="d-flex align-items-center sidebar-p-a border-bottom bg-light">
        ...
        <div class="dropdown ml-auto">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="settings">Edit account</a>
...
<div class="sidebar-block p-0">
    ...
    <ul class="sidebar-menu mt-0">
        <li class="sidebar-menu-item <?php if ($pageHeader === "Student Dashboard") : echo "active";
                                        endif; ?>">
        ...
        <li class="sidebar-menu-item <?php if ($pageHeader === "Student Course") : echo "active";
                                        endif; ?>">
        ...
        <li class="sidebar-menu-item <?php if ($pageHeader === "Student Result") : echo "active";
                                        endif; ?>">
            <a class="sidebar-menu-button" href="view-result">
                <span class="sidebar-menu-icon sidebar-menu-icon--left">
        ...
        <li class="sidebar-menu-item <?php if ($pageHeader === "Student Profile") : echo "active";
                                        endif; ?>">
