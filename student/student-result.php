...
if (isset($_GET['acad']) && isset($_GET['term'])) {
    $preferred_year = $_GET['acad'];
    $preferred_term = $_GET['term'];
}
                    ...
                    <div class="col-lg-12">
                        <table class="table table-light table-responsive-sm table-responsive-md shadow">
                            ...
                            <tbody>
                                ...
                                <?php
                                $results = viewSelectedResult("results", "student_id_fk", $details['id'], $preferred_year, $preferred_term);
                                if (!empty($results)) {
