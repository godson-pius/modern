        ...
        <div class="mdk-drawer-layout__content page">
            ...
            <div class="container-fluid page__heading-container">
                <div class="page__heading d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-lg-between text-center text-lg-left">
                    ...
                    <a href="instructor-profile" class="btn btn-dark shadow"><i class="material-icons">arrow_forward</i> <?= $details['teacher_name']; ?></a>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="fname" name="fullname" type="text" class="form-control" placeholder="First name" value="<?= $details['teacher_name']; ?>">
                                                    </div>
                                                </div>
                                            </div>
